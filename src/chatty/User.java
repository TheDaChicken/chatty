...
public class User implements Comparable<User> {
    ...
    public User(String channel_id, Room room) {
        this(channel_id, null, room);
    }
     ...
     * before
     */
    public synchronized boolean setBadges(Map<String, String> badges) {
     ...
     * @return
     */
    public synchronized Map<String, String> getBadges() {
        return twitchBadges;
    }
     ...
     * otherwise
     */
    public synchronized boolean hasBadge(String id) {
        return twitchBadges != null && twitchBadges.containsKey(id);
    }

    public synchronized boolean hasBadge(String id, String version) {
    ...
    public synchronized boolean hasModeratorRights() {
        return isBroadcaster() || isGlobalMod() || isModerator()
                || isStaff();
    }
